...
|---|---|---|
| `endeffector/` | one per swappable end effector (tool ids 1..n, IPs 10.13.60.31+) | DRV8833-driven DC motor, open-loop timed runs ("forward/backward for x ms at speed y"); serves HTTP v0 (`docs/contracts.md §C.2`) |
