...
- Pinned versions — do not drift: WPILib/GradleRIO 2026.2.1 · Java 17 · PathPlannerLib 2026.1.2 · Phoenix6 26.3.0 (`https://api.ctr-electronics.com/phoenix6/stable/java/`) · PhotonLib v2026.3.4 · AdvantageKit 26.0.2 · PlatformIO 6.2.0 / espressif32 (Arduino core 3.2.0). Never re-run `./gradlew vendordep` against the rolling Phoenix6 URL; the committed JSON is the pin.
